...
# from .models import UserEmployer, Post, QRCode
# from .serializers import UserEmployerSerializer, PostSerializer, QRCodeSerializer
...
# class UserEmployerListCreateView(generics.ListCreateAPIView):
#     queryset = UserEmployer.objects.all()
#     serializer_class = UserEmployerSerializer
#     # permission_classes = [permissions.IsAuthenticated]
